    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      {showContent && (
        ...
        >
          ...
          >
            <h3 className="font-display text-sm font-bold text-muted-foreground mb-3 text-center">Completed Tasks</h3>
          ...
          >
            ...
            <button onClick={resetRoutine} className={onStoryTime ? 'w-full py-3 text-sm font-semibold text-muted-foreground hover:text-foreground transition-colors' : 'btn-primary w-full'}>
              🔄 Start Over
            </button>
          </motion.div>
        </motion.div>
